...
func (e *ExecutionPayloadHeaderV1) UnmarshalJSON(input []byte) error {
	...
	if dec.Coinbase == nil {
		return errors.New("missing required field 'coinbase' for ExecutionPayloadHeaderV1")
	}
	...
	if dec.ReceiptRoot == nil {
		return errors.New("missing required field 'receiptRoot' for ExecutionPayloadHeaderV1")
	}
	...
	if dec.Random == nil {
		return errors.New("missing required field 'random' for ExecutionPayloadHeaderV1")
	}
	e.Random = *dec.Random
	if dec.Number == nil {
