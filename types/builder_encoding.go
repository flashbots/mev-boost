...
// Hash: 39d34b80b8b0276cf8d62c9f2890ad283a3f3d52e7bac7bf7dfd410c3ebf1f55
package types
...
func (a *Attestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(a.AggregationBits))
		if byteLen > 2048 {
...
func (e *ExecutionPayloadHeader) UnmarshalSSZ(buf []byte) error {
	...
	// Field (10) 'ExtraData'
	copy(e.ExtraData[:], buf[436:468])

	// Field (11) 'BaseFeePerGas'
	copy(e.BaseFeePerGas[:], buf[468:500])

	// Field (12) 'BlockHash'
	copy(e.BlockHash[:], buf[500:532])

	// Field (13) 'TransactionsRoot'
	copy(e.TransactionsRoot[:], buf[532:564])
...
func (b *BlindedBeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.ExecutionPayloadHeader.UnmarshalSSZ(buf[380:944]); err != nil {
		return err
	}
	...
	{
		buf = tail[o6:o7]
		num, err := ssz.DivideInt2(len(buf), 184, 4)
		if err != nil {
			return err
		}
